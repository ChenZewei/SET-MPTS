...
RTA_PFP_FF_OPA::RTA_PFP_FF_OPA():PartitionedSched(false, RTA, FIX_PRIORITY, NONE, "", "NONE") {}

RTA_PFP_FF_OPA::RTA_PFP_FF_OPA(TaskSet tasks, ProcessorSet processors, ResourceSet resources):PartitionedSched(false, RTA, FIX_PRIORITY, NONE, "", "NONE")
{
	this->tasks = tasks;
...
ulong RTA_PFP_FF_OPA::response_time(Task& ti)
{
	//uint t_id = ti.get_id();
...
bool RTA_PFP_FF_OPA::BinPacking_FF(Task& ti, TaskSet& tasks, ProcessorSet& processors, ResourceSet& resources, uint MODE)
{
