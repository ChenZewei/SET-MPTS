...
bool RTA_PFP_ROP_HETEROGENEOUS::is_schedulable() {
    ...
    if (schedulable) {
      /*
         ...
         partition:"<<task->get_partition()<<endl;
                                      cout<<"ncs-wcet:"<<task->get_wcet_non_critical_sections_heterogeneous()<<"
         cs-wcet:"<<task->get_wcet_critical_sections_heterogeneous()<<"
         wcet:"<<task->get_wcet_heterogeneous()<<" response
  ...
  /*
     ...
     cs-wcet:"<<task->get_wcet_critical_sections_heterogeneous()<<"
     wcet:"<<task->get_wcet_heterogeneous()<<" response
     time:"<<task->get_response_time()<<" deadline:"<<task->get_deadline()<<"
     period:"<<task->get_period()<<endl; foreach(task->get_requests(), request)
                  {
                          cout<<"request"<<request->get_resource_id()<<":"<<"
     num:"<<request->get_num_requests()<<"
     length:"<<request->get_max_length()<<"
