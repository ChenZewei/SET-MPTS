...
LP_RTA_GFP_FMLP::LP_RTA_GFP_FMLP(): LPSched(RTA, GLOBAL, FIX_PRIORITY, FMLP, "", "FMLP") {}

LP_RTA_GFP_FMLP::LP_RTA_GFP_FMLP(TaskSet& tasks, ProcessorSet& processors, ResourceSet& resources): LPSched(RTA, GLOBAL, FIX_PRIORITY, FMLP, "", "FMLP")
{
	this->tasks = tasks;
