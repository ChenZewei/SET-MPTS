...
DAG_GEDF_BON(DAG_TaskSet tasks, ProcessorSet processors, ResourceSet resources, double e = 0.1): GlobalSched(false, SB, EDF, NONE, "", "DAG")
{
	this->tasks = tasks;
...
set<Work> DAG_GEDF_BON::precise_workload(DAG_Task &dag_task, ulong T)
{
...
ulong DAG_GEDF_BON::approximate_workload(DAG_Task &dag_task, ulong T)
{
