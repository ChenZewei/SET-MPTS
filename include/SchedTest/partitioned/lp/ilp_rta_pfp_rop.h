#ifndef ILP_RTA_PFP_ROP_H
#define ILP_RTA_PFP_ROP_H
...
class ILP_RTA_PFP_ROP: public PartitionedSched
{
	private:
		...
		void construct_exp(ILPROPMapper& vars, LinearExpression *exp, uint type, uint part_1 = 0, uint part_2 = 0, uint part_3 = 0, uint part_4 = 0);
	...
	public:
		ILP_RTA_PFP_ROP();
		ILP_RTA_PFP_ROP(TaskSet tasks, ProcessorSet processors, ResourceSet resources);
		~ILP_RTA_PFP_ROP();
		bool is_schedulable();
};
